...
const CustomersPage = () => {
  ...
  const applyCustomerImport = async () => {
    ...
    try {
      ...
      setCustomerImportStatus({
        type: "success",
        message: `Inserted ${insertedCount}, merged ${mergedCount}, created ${historyRowsCreated} history entries, skipped ${skippedCount}. ${failedRows.length} rows failed and can be retried.`,
      });
      await fetchCustomers();
    } catch (error) {
