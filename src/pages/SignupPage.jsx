              ...
              <form onSubmit={handleSignup} className="space-y-6">
                ...
                <div className="space-y-1">
                  <input
                    ...
                    required
                  />
                  <p className="text-[8px] text-[#6B6360] uppercase tracking-widest mt-1 opacity-50">
                    min. 6 characters & 1 number
                  </p>
                </div>
                ...
                <div className="flex flex-col space-y-4 pt-4">
                  ...
                  <Link to="/login" className="text-[9px] tracking-widest text-[#6B6360] uppercase font-medium hover:text-[#0A0A0A] transition-colors">
